...
func (b *BlueSky) CreatePost(ctx context.Context, text string, images ...socialmedia.Image) error {
...
func (b *BlueSky) format(ctx context.Context, images []socialmedia.Image) (*comatproto.RepoCreateRecord_Input, error) {
	postMsg := ""
...
func (b *BlueSky) getEmbedData(ctx context.Context, images []socialmedia.Image) (*appbsky.FeedPost_Embed, error) {
